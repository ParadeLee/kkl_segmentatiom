...
class brainwebLoader_new(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        background = np.array(background.convert('L'), 'f')
        lbl = np.pad(lbl, ((0, newsize-H), (0, newsize-W)), 'constant', constant_values=(0, 0))
        # print(str(lbl))
        lbl = background + lbl
