...
class MlpRnn(nn.Module):
    ...
    def forward(self, inputs):
        ...
        h4_UT_hd3 = self.h4_UT_hd3_relu(self.h4_UT_hd3_bn(self.h4_UT_hd3_conv(self._upsample(h4, h3))))
        h5_UT_hd3 = self.h5_UT_hd3_relu(self.h5_UT_hd3_bn(self.h5_UT_hd3_conv(self._upsample(hd5, h3))))
        fusion_map = self.relu3d_1(self.bn3d_1(self.conv3d_1(
            torch.cat((h1_PT_hd3, h2_PT_hd3, h3_Cat_hd3, h4_UT_hd3, h5_UT_hd3), 1))))

        x2 = self.CrossAttention4(x2, fusion_map)
        x3 = self.CrossAttention3(x3, fusion_map)
        x4 = self.CrossAttention2(x4, fusion_map)
        x5 = self.CrossAttention1(x5, fusion_map)
